...
#[OA\Info(title: 'InstaHost', version: '0.1')]
#[OA\Server(url: 'https://app.coolify.io/api/v1', description: 'InstaHost API. Change the host to your own instance if you are self-hosting.')]
#[OA\SecurityScheme(
    type: 'http',
    scheme: 'bearer',
