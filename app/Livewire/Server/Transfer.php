...
class Transfer extends Component
{
    ...
    public function migrateServer(ServerTransferMigrator $migrator): void
    {
        ...
        try {
            ...
            if ($this->isLocalhost) {
                throw new \RuntimeException('The InstaHost host (localhost) cannot be transferred.');
            }
    ...
    public function completeTransfer(ServerTransferClaimer $claimer): void
    {
        ...
        try {
            $this->authorize('update', $this->server);
            if ($this->isLocalhost) {
                throw new \RuntimeException('The InstaHost host cannot be marked as transferred.');
            }
    ...
    public function claimServer(ServerTransferClaimer $claimer): void
    {
        ...
        try {
            $this->authorize('update', $this->server);
            if ($this->isLocalhost) {
                throw new \RuntimeException('The InstaHost host cannot be claimed.');
            }
