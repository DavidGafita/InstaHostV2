...
class GetInfrastructureOverview extends Tool
{
    ...
    protected string $description = 'High-level overview of the authenticated team: InstaHost version, servers, projects with resource counts, open deployments, and SQL-based health_hints counts. Start here or with coolify_help / search_resources.';
