...
class RestartLimitReached extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("InstaHost: {$this->resource_name} stopped - restart limit reached ({$this->restart_count}/{$this->max_restart_count})");
    ...
    {
        $message = "InstaHost: {$this->resource_name} has been stopped after {$this->restart_count} restarts (limit: {$this->max_restart_count}).";

        return [
            'message' => $message,
            'buttons' => [
                [
                    'text' => 'Open Resource in InstaHost',
