...
class Reachable extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("InstaHost: Server ({$this->server->name}) revived.");
    ...
    {
        return [
            'message' => "InstaHost: Server '{$this->server->name}' revived. All automations & integrations are turned on again!",
        ];
    }
