...
class TraefikVersionOutdated extends CustomEmailNotification
{
    ...
    public function toMail($notifiable = null): MailMessage
    {
        ...
        $mail->subject("InstaHost: Traefik proxy outdated on {$count} server(s)");
    ...
    public function toDiscord(): DiscordMessage
    {
        ...
        return new DiscordMessage(
            title: ':warning: InstaHost: Traefik proxy outdated',
    ...
    public function toTelegram(): array
    {
        ...
        $message = "⚠️ InstaHost: Traefik proxy outdated on {$count} server(s)!\n\n";
    ...
    public function toSlack(): SlackMessage
    {
        ...
        return new SlackMessage(
            title: 'InstaHost: Traefik proxy outdated',
            description: $description,
