<nav class="flex flex-col flex-1 bg-white border-r border-[#e3e7ef] dark:border-white/[0.06] dark:bg-panel pt-2"
    ...
    @if (isSubscribed() || ! isCloud())
        <div class="px-1 pb-3" :class="collapsed && 'lg:px-0 lg:flex lg:justify-center'">
            <button @click="$dispatch('open-global-search')" type="button"
                ...
                class="menu-item justify-between !bg-[#f7f8fb] dark:!bg-white/[0.04] hover:!bg-[#f7f3fb] dark:hover:!bg-white/[0.07] !text-[#62738d] ring-1 ring-inset ring-[#cfd7e6] dark:ring-white/10"
