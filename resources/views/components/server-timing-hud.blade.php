...
(function () {
    ...
    function formatEntryForAi(entry) {
        ...
        const lines = [
            '## InstaHost Server-Timing debug dump',
            '',
            'Use this to investigate a slow or expensive HTTP/Livewire response in InstaHost (Laravel).',
            '',
            '### Selected request',
        ...
        lines.push(
            ...
            '- Values come from InstaHost dev Server-Timing middleware (`app.server_timing`).',
