        ...
        <div class="flex w-full flex-col items-center space-y-6">
            @if ($currentState === 'welcome')
                <div class="w-full max-w-3xl">
                    <div class="mb-6 text-center">
                        <h1 class="text-2xl! font-semibold!">Welcome to InstaHost</h1>
            ...
            @elseif ($currentState === 'explanation')
                ...
                <x-boarding-step title="Platform Overview">
                    <x-slot:question>
                        InstaHost automates deployment and infrastructure management on your own servers. Deploy applications
                        from Git, manage databases, and monitor everything without vendor lock-in.
                    </x-slot:question>
                    <x-slot:explanation>
                        <p>
                            <x-highlighted text="Automation:" /> InstaHost handles server configuration, Docker management,
                            and
                        ...
                        <div class="w-full space-y-6">
                            ...
                            <button
                                ...
                                <span role="button" tabindex="0" aria-label="About this machine"
                                    data-tooltip="The machine running InstaHost. Not recommended for production workloads due to resource contention."
                                ...
                                <div class="flex flex-col gap-4 text-left">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm dark:text-neutral-400">
                                            Deploy on the server running InstaHost. Best for testing and single-server setups.
                                        </p>
                                    </div>
                                </div>
                            </button>
                            ...
                            <div class="mt-6 p-4 border border-error rounded-lg text-gray-800 dark:text-gray-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <ul class="list-disc list-inside">
                                        ...
                                        <li>Or skip the boarding process and manually add a new private key to InstaHost and
                                            the server</li>
                                    </ul>
                                </div>
            ...
            @elseif ($currentState === 'private-key')
                ...
                <x-boarding-step title="SSH Authentication">
                        ...
                        <div class="grid w-full grid-cols-1 gap-3 lg:grid-cols-2">
                            ...
                            <button type="button"
                                ...
                                <span class="min-w-0">
                                    ...
                                    <span class="mt-0.5 block text-[12px] leading-5 text-neutral-500 dark:text-fg-dim">
                                        Create an ED25519 key pair in InstaHost.
                                    </span>
                                </span>
                            </button>
                        </div>
                    ...
                    <x-slot:explanation>
                        ...
                        <p>
                            <x-highlighted text="Key Generation:" /> InstaHost generates ED25519 keys by default for optimal
            ...
            @elseif ($currentState === 'create-private-key')
                ...
                <x-boarding-step title="SSH Key Configuration">
                    ...
                    <x-slot:explanation>
                        <p>
                            <x-highlighted text="Key Storage:" /> Private keys are encrypted at rest in InstaHost's database.
                        </p>
                        <p>
            ...
            @elseif ($currentState === 'validate-server')
                ...
                <x-boarding-step title="Server Validation">
                    <x-slot:question>
                        InstaHost will automatically install Docker {{ $minDockerVersion }}+ if not present.
                    </x-slot:question>
                    <x-slot:actions>
                    ...
                    <x-slot:explanation>
                        <p>
                            <x-highlighted text="Automated Setup:" /> InstaHost installs Docker Engine, Docker Compose, and
