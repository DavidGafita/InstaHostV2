<div>
    <x-slot:title>
        {{ $destination->name }} | Destination | InstaHost
    </x-slot>
                                ...
                                <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                    <div class="min-w-0">
                                        ...
                                        <p class="mt-2 max-w-2xl text-[13px] leading-5 text-neutral-600 dark:text-fg-dim">
                                            ...
                                            from InstaHost. The Docker network is also removed from the server.
                                        </p>
                                    ...
                                    @else
                                        <x-forms.button disabled tooltip="The default InstaHost destination cannot be deleted.">
                                            Delete destination
                                        </x-forms.button>
                                    @endif
                                </div>
