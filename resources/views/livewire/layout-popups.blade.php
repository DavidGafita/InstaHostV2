                ...
                if (window.Echo) {
                    if (window.Echo.connector.pusher.connection.state === 'connected') {
                        ...
                        if (checkNumber > 5) {
                            ...
                            console.error(
                                'InstaHost could not connect to its real-time service. This will cause unusual problems on the UI if not fixed! Please check the related documentation (https://coolify.io/docs/knowledge-base/cloudflare/tunnels/overview) or get help on Discord (https://coollabs.io/discord).)'
                            );
                        }
                ...
                <x-slot:customActions>
                    <div class="relative mx-auto flex w-full flex-col overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-modal transition-all duration-300 dark:border-white/[0.1] dark:bg-surface"
                        ...
                        <div class="flex items-start gap-4 pr-8">
                            ...
                            <div class="min-w-0">
                                <h2 class="text-[15px]! leading-5! font-semibold! text-black dark:text-fg">
                                    Love InstaHost? Support our work.
                                </h2>
                                <p x-show="!reminders.sponsorship.compact" x-transition.opacity
                                    ...
                                    InstaHost is profitable thanks to <span
