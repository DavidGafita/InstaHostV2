<div x-data="{
    ...
    <form wire:submit='submit' class="application-settings-form flex flex-col">
        ...
        <div class="application-settings-grid flex flex-col gap-6">
            <x-application.settings-section id="application-details-section" title="Application details" helper="Name the application and choose the build strategy InstaHost should use to deploy it." class="application-details-card">
                            ...
                            @if ($buildPack !== 'dockercompose')
                                ...
                                <div class="grid gap-4 pt-2 sm:grid-cols-2">
                                    <x-forms.listbox id="isBuildServerEnabled" label="Builder selection"
                                        ...
                                        helper="Build your application on a dedicated build server. If several build servers are connected, InstaHost picks an available one automatically. More info in the <a href='https://coolify.io/docs/knowledge-base/server/build-server' class='underline' target='_blank'>documentation</a>."
                                        x-bind:disabled="!canUpdate" />
                                </div>
                            @endif
                        @endif
                ...
                <div x-data="{ showRaw: true }" class="mt-5">
                    ...
                    <div class="w-full sm:w-96">
                        ...
                        {{-- <x-forms.checkbox label="Readonly labels"
                            helper="Labels are readonly by default. Readonly means that edits you do to the labels could be lost and InstaHost will autogenerate the labels for you. If you want to edit the labels directly, disable this option. <br><br>Be careful, it could break the proxy configuration after you restart the container as InstaHost will now NOT autogenerate the labels for you (ofc you can always reset the labels to the coolify defaults manually)."
            ...
            @if ($buildPack !== 'dockercompose')
                ...
                <x-application.settings-section id="runtime-section" title="Runtime" helper="Options applied to the container when it starts.">
                    <x-forms.input
                        helper="You can add custom docker run options that will be used when your container is started.<br>Note: Not all options are supported, as they could mess up InstaHost's automation and could cause bad experience for users.<br><br>Check the <a class='underline dark:text-white' href='https://coolify.io/docs/knowledge-base/docker/custom-commands'>docs.</a>"
                ...
                <x-application.settings-section id="security-section" title="Security" helper="Protect this application with authentication at the proxy level.">
                    ...
                    <x-empty size="sm" title="Authentication is managed through labels"
                        description="Authentication is managed via manual proxy labels. Switch label management back to InstaHost to configure it here."
                        icon-name="admin">
                        <x-slot:contents>
                    ...
                    <x-forms.listbox id="isHttpBasicAuthEnabled" label="Authentication" onChange="instantSave"
                        helper="HTTP Basic Authentication adds the required authentication labels to the proxy. InstaHost currently supports a single username and password."
                        :options="[
            ...
            @if ($buildPack !== 'dockercompose')
                ...
                <div class="grid w-full gap-4 sm:grid-cols-2">
                    <x-forms.listbox id="isContainerLabelReadonlyEnabled" label="Label management"
                        ...
                        helper="When InstaHost manages the labels, they are regenerated automatically and manual edits can be lost.<br><br>If you edit them yourself, be careful: a wrong label set can break the proxy configuration after a restart (you can always reset to the InstaHost defaults)."
                        :options="[
                            ['value' => true, 'label' => 'Managed by InstaHost (auto-generated)'],
                ...
                <div class="mt-5 border-t border-neutral-200 pt-5 dark:border-white/[0.07]">
                    <div class="mb-1.5 flex items-center justify-between gap-3">
                        ...
                        @can('update', $application)
                            <x-modal-confirmation title="Confirm Labels Reset to InstaHost Defaults?"
