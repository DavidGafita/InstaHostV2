    ...
    <form wire:submit="submit" class="flex flex-col gap-6">
        ...
        <x-application.settings-section title="Runtime and network"
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                <div class="lg:col-span-2">
                    <x-forms.input
                        helper="Add supported docker run options used when the container starts. Unsupported options can interfere with InstaHost automation."
...
# timeout 300"
                helper="InstaHost automatically applies requirepass using the password above. If you override requirepass here, keep both values identical."
