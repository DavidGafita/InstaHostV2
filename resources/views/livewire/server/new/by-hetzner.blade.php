    ...
    @elseif ($current_step === 1)
        <div class="flex flex-col gap-6">
            ...
            <p class="text-[11px] text-neutral-500 dark:text-fg-faint">
                ...
                through InstaHost's affiliate link.
            </p>
        </div>
            ...
            @else
                ...
                <form wire:submit="submit" class="flex flex-col gap-6">
                    <x-application.settings-section title="Hetzner server"
                        description="Choose the location, hardware, operating system, and InstaHost SSH key.">
                        <x-slot:actions>
                            <button type="submit"
                        ...
                        <div class="grid gap-4 lg:grid-cols-2">
                            <div class="lg:col-span-2">
                                <x-forms.input id="server_name" label="Server name"
                                    helper="A friendly name shown in InstaHost." />
                            </div>
