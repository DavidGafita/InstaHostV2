<div x-data
    ...
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(24) }} | Server | InstaHost
    </x-slot>
            ...
            @else
                ...
                <form wire:submit.prevent="submit" class="application-settings-form flex flex-col gap-6">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 text-xs leading-5 text-neutral-500 dark:text-fg-dim">
                                    @if ($server->isTransferredAway())
                                        This server was migrated away from this InstaHost instance and cannot be managed here.
                    ...
                    <x-application.settings-section id="server-connection-section" title="Connection"
                        helper="Configure how InstaHost identifies, reaches, and validates this server.">
                        <x-slot:actions>
                        ...
                        @if ($server->isTransferredAway())
                            <x-callout type="warning" title="Transferred to another instance" class="mb-4">
                                This server was migrated away from this InstaHost instance. It cannot be revalidated or
