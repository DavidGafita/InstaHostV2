            ...
            @else
                <x-application.settings-section title="Instance backup">
                    <x-empty title="Backup is not configured"
                        description="InstaHost needs an internal database resource to create automatic backups."
                        icon-name="database" size="sm">
                        <x-slot:actions>
                            <x-forms.button wire:click="addInstaHostDatabase" isHighlighted>
                                Configure backup
                            </x-forms.button>
                        </x-slot:actions>
                    </x-empty>
