<div>
    ...
    <x-settings.layout>
        <form wire:submit="submit" class="application-settings-form flex min-w-0 flex-col gap-6">
            ...
            <x-application.settings-section title="Update InstaHost"
                helper="Install the latest InstaHost version manually when an update is available.">
