<div>
    <x-slot:title>
        {{ $github_app->name ?: 'GitHub App' }} | Sources | InstaHost
    </x-slot>
                                        ...
                                        @if (!isCloud())
                                            <div class="lg:col-span-2">
                                                <x-forms.listbox canGate="update" :canResource="$github_app" id="isSystemWide" label="Availability" :options="[
                                                    ...
                                                    helper="System-wide GitHub Apps can be used by every team on this InstaHost instance."
                                        ...
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                            <div class="min-w-0">
                                                ...
                                                <p class="mt-2 max-w-2xl text-[13px] leading-5 text-neutral-600 dark:text-fg-dim">
                                                    ...
                                                    from InstaHost. Applications using this source will need another Git provider configured.
                                                </p>
                                                <ul class="mt-3 space-y-1 text-xs text-neutral-500 dark:text-fg-dim">
                                                    ...
                                                    <li>• This source cannot be restored from InstaHost after deletion.</li>
                                                </ul>
                                            </div>
                    ...
                    <x-application.settings-section title="Automated installation"
                        ...
                        <div class="flex min-h-[24rem] flex-col gap-4">
                            ...
                            <x-forms.listbox id="preview_deployment_permissions"
                                ...
                                helper="Write access lets InstaHost post deployment status and links on pull requests." />
