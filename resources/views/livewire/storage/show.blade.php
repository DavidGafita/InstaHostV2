<div>
    <x-slot:title>
        {{ data_get_str($storage, 'name')->limit(20) }} | S3 Storage | InstaHost
    </x-slot>
                                    ...
                                    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                        <div class="min-w-0">
                                            ...
                                            <p class="mt-2 max-w-2xl text-[13px] leading-5 text-neutral-600 dark:text-fg-dim">
                                                ...
                                                from InstaHost. Existing objects in the bucket are not deleted.
                                            </p>
                                            <ul class="mt-3 space-y-1 text-xs text-neutral-500 dark:text-fg-dim">
                                                ...
                                                <li>• This storage destination cannot be restored from InstaHost after deletion.</li>
                                            </ul>
                                        </div>
                                            ...
                                            @can('delete', $storage)
                                                <x-modal-confirmation title="Confirm Storage Deletion?" isErrorButton
                                                    ...
                                                    :actions="array_filter([
                                                        'The selected storage location will be permanently deleted from InstaHost.',
                                                        $backupCount > 0
