                        ...
                        <div class="shrink-0">
                            @if (
                                ...
                                <x-modal-confirmation title="Confirm Team Deletion?" buttonTitle="Delete team"
                                    ...
                                    :actions="['The current team will be permanently deleted from InstaHost and the database.']"
