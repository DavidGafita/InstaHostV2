...
/**
 * Auth shell headers should brand the product so users know they are on InstaHost.
 */
test('login register and forgot password headers are InstaHost', function () {
